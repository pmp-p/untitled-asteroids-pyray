from raylib import KEY_SPACE, KEY_RIGHT, KEY_LEFT, KEY_DOWN, KEY_UP, WHITE, YELLOW, RED
...
class Points(Sprite2D):
    ...
    def draw_points(self):
        ...
        draw_text_ex(self._font, "score:" + str(self.get_current_points()), Vector2(self.get_position().x * SCALE_FACTOR
            , self.get_position().y * SCALE_FACTOR), POINTS_FONT_SIZE * SCALE_FACTOR, 8.0, (253, 249, 0, 255))
